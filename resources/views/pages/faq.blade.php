          ...
          <span class="input-group-prepend input-group-text">
            <i class="bi-search"></i>
                                        ...
                                        <input type="text" class="form-control" id="searchAppsForm"
                                               placeholder="Search in FAQ" aria-label="Search for apps">
                                    </div>
                                </div>
                    ...
                    <div class="accordion accordion-flush accordion-lg" id="accordionFAQBasics">
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="collapseBasicsOne" class="accordion-collapse collapse show"
                                ...
                                <div class="accordion-body">
                                    ...
                                    Stripe) or with your Paypal account. We don't support cryptocurrencies or invoicing
                                    at this time.
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="collapseBasicsTwo" class="accordion-collapse collapse"
                                 aria-labelledby="headingBasicsTwo" data-bs-parent="#accordionFAQBasics">
                                <div class="accordion-body">
                        ...
                        <div class="accordion-item">
                            <div class="accordion-header" id="headingBasicsFour">
                                <a class="accordion-button collapsed" role="button" data-bs-toggle="collapse"
                                   data-bs-target="#collapseBasicsFour" aria-expanded="false"
                                   aria-controls="collapseBasicsFour">
                                    Which license do I need?
                                </a>
                            </div>
                            <div id="collapseBasicsFour" class="accordion-collapse collapse"
                                 aria-labelledby="headingBasicsFour" data-bs-parent="#accordionFAQBasics">
                                <div class="accordion-body">
                                    There are three license types - <a href="#">Standard</a>, <a href="#">Multisite</a>,
                                    and <a href="#">Extended</a>. We've provided the table below for a quick look at the
                                    difference between the them, as well as a few examples of ways each license could be
                                    used. If you'd like more of the nitty-gritty details you can find them below and
                                    always feel free to reach out with any questions you have at <a href="#">themes@getbootstrap.com</a>.
                                </div>
                            </div>
                        </div>
                        <!-- End Accordion Item -->
                        ...
                        <div class="accordion-item">
                            <div class="accordion-header" id="headingBasicsFive">
                                <a class="accordion-button collapsed" role="button" data-bs-toggle="collapse"
                                   data-bs-target="#collapseBasicsFive" aria-expanded="false"
                                   aria-controls="collapseBasicsFive">
                                    How do I get access to a theme I purchased?
                                </a>
                            </div>
                            <div id="collapseBasicsFive" class="accordion-collapse collapse"
                                 aria-labelledby="headingBasicsFive" data-bs-parent="#accordionFAQBasics">
                                <div class="accordion-body">
                        ...
                        <div class="accordion-item">
                            <div class="accordion-header" id="headingBasicsSix">
                                <a class="accordion-button collapsed" role="button" data-bs-toggle="collapse"
                                   data-bs-target="#collapseBasicsSix" aria-expanded="false"
                                   aria-controls="collapseBasicsSix">
                                    Upgrade License Type
                                </a>
                            </div>
                            <div id="collapseBasicsSix" class="accordion-collapse collapse"
                                 aria-labelledby="headingBasicsSix" data-bs-parent="#accordionFAQBasics">
                                <div class="accordion-body">
                    ...
                    <div class="accordion accordion-flush accordion-lg" id="accordionFAQSupport">
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="collapseSupportOne" class="accordion-collapse collapse"
                                ...
                                <div class="accordion-body">
                                    Technical support for each theme is given directly by the creator of the theme.
                                    You'll be given a link to contact their support in a couple places:

                                    <ul>
                                        <li>Your confirmation email: Each theme in your confirmation email will have
                                            both the download link for your theme, and a "support" link which will
                                            connect you directly with the sellers support system or email.
                                        </li>
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="collapseSupportTwo" class="accordion-collapse collapse"
                                ...
                                <div class="accordion-body">
                                    All of the themes are built on versions of Bootstrap v4, currently all are on the
                                    v4.0.0 stable build. As more Bootstrap updates are launched the themes will be
                                    update as needed and as new features and bug fixes come out. You will want to
                                    download any updates that come out and update your installation as required.
                                </div>
                            </div>
                        </div>
                        <!-- End Accordion Item -->
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="collapseSupportThree" class="accordion-collapse collapse"
                                ...
                                <div class="accordion-body">
                                    For anything we haven't covered feel free to reach out to the Bootstrap Themes team
                                    at <a href="#">themes@getbootstrap.com</a> !We're here to help.
                                </div>
                            </div>
                        </div>
                        <!-- End Accordion Item -->
                    ...
                    <div class="accordion accordion-flush accordion-lg" id="accordionFAQPayments">
                        ...
                        <div class="accordion-item">
                            <div class="accordion-header" id="headingPaymentsTwo">
                                <a class="accordion-button collapsed" role="button" data-bs-toggle="collapse"
                                   data-bs-target="#collapsePaymentsTwo" aria-expanded="false"
                                   aria-controls="collapsePaymentsTwo">
                                    How do I get a receipt for my purchase?
                                </a>
                            </div>
                            <div id="collapsePaymentsTwo" class="accordion-collapse collapse"
                                 aria-labelledby="headingPaymentsTwo" data-bs-parent="#accordionFAQPayments">
                                <div class="accordion-body">
                                    You'll receive an email from Bootstrap themes once your purchase is complete.
                                </div>
                            </div>
                        ...
                        <div class="accordion-item">
                            <div class="accordion-header" id="headingPaymentsThree">
                                <a class="accordion-button collapsed" role="button" data-bs-toggle="collapse"
                                   data-bs-target="#collapsePaymentsThree" aria-expanded="false"
                                   aria-controls="collapsePaymentsThree">
                                    How can I get a refund?
                                </a>
                            </div>
                            <div id="collapsePaymentsThree" class="accordion-collapse collapse"
                                 aria-labelledby="headingPaymentsThree" data-bs-parent="#accordionFAQPayments">
                                <div class="accordion-body">
                                    If you'd like a refund please reach out to us at <a
                                            href="#">themes@getbootstrap.com</a>. If you need technical help with the
                                    theme before a refund please reach out to the seller first and they can get in touch
